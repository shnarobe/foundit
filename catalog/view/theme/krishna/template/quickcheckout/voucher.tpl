...
<div class="onepage-ch-heading" id="coupon-heading"><i class="fa fa-gift"></i> Do you have discount?</div>
...
<div id="reward-content">
  <div class="input-group">
	<input type="text" name="reward" value="" class="form-control" placeholder="<?php echo $text_use_reward; ?>" />
	<span class="input-group-btn">
