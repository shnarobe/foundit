<form class="form-horizontal" id="shipping-form-k">
  <?php if ($addresses) { //var_dump($addresses);
  ?>
  <div class="radio">
    <label>
  ...
  <div class="buttons clearfix" id="hide-shipping-address" style="display:none;">
...
$('input[name=\'shipping_address\']').on('change', function() {
	if (this.value == 'new') {
		...
		$('#shipping-new').show();
		$('#hide-shipping-address').show();
		
	} else {
		$('#shipping-existing').show();
		$('#shipping-new').hide();
		$('#hide-shipping-address').hide();

	}
});

function trial(){
	//var f=document.getElementById("shipping-form-k");
	//console.log f;
...
shippingformk=$("#shipping-form-k").serialize();
...
//--></script>
<script type="text/javascript"><!--
/*$('#shipping-existing select[name=\'address_id\']').change(function() {
	console.log('called');
	//onek();
	//threek();
...
$('#shipping-existing select').on('change',function(){
	...
	//user changes their shipping address, serialize form with updated value
	shippingformk=$("#shipping-form-k").serialize();
	//get current payment address and pass to onekone
	//paymentformk=sessionStorage.getItem("payment-address-k");
	//onekone(paymentformk);
	//update local storage
	sessionStorage.removeItem("shipping-address-k");
	sessionStorage.setItem("shipping-address-k",shippingformk);
	//get local storage for shipping method
	//arg2=sessionStorage.getItem("shipping-address-k");
	twoktwo(shippingformk);
