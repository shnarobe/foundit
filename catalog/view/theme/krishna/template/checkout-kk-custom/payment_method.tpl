...
<div class="buttons">
  <div class="pull-right"><?php echo $text_agree; ?>
    ...
    <?php } ?>
    &nbsp;
    <input type="button" value="<?php echo "Place your order"//$button_continue; ?>" id="button-payment-method" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary" />
  </div>
</div>
<?php } else { ?>
<div class="buttons">
