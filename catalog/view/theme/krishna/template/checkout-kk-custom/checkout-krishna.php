...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
	 ...
	 <?php $breadcrumbsTwo=array();
	 $breadcrumbsTwo[]=array('href'=>'#home','text'=>'Address and Shipping');
	  $breadcrumbsTwo[]=array('href'=>'#menu1','text'=>'Payment details');
	   $breadcrumbsTwo[]=array('href'=>'#menu2','text'=>'Review and Pay');
	 ?>
	  <ul class="breadcrumb">
    <?php foreach ($breadcrumbsTwo as $breadcrumb) { ?>
    <li><a href="<?php echo $breadcrumb['href']; ?>" data-toggle="tab"><?php echo $breadcrumb['text']; ?></a></li>
    <?php } ?>
  </ul>
   <!-- <li class="active"><a data-toggle="tab" href="#home">Address and Shipping</a></li>
    <li><a data-toggle="tab" href="#menu1">Payment Information</a></li>
    <li><a data-toggle="tab" href="#menu2">Review order and Pay</a></li>
