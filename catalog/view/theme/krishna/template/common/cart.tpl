<div id="cart" class="btn-group btn-block">
  <button type="button"  data-loading-text="<?php echo $text_loading; ?>" class="btn btn-inverse btn-block btn-md" onclick="krishna('<?php echo $cart; ?>');"><i class="fa fa-shopping-cart"></i> <span id="cart-total"><?php echo $text_items; ?></span></button>
