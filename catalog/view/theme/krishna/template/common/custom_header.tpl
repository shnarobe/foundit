...
<!-- <nav ><!-- top menu
	<div class="container-fluid">
		<div class="row">
			<span class="col-sm-1"><img src="image/cache/catalog/demo/imac_3-74x74.jpg"/></span>
			<span class="col-sm-1"><img src="image/cache/catalog/demo/iphone_3-74x74.jpg"/></span>
			<span class="col-sm-4" style="padding-left:0px; padding-right:0px;"><h3 style="color:#191970;">Find whatever you're looking for! <button type="button" class="btn btn-info" style="">Shop Now</button></h3></span>
    ...
    <?php //echo $language; ?>
      ...
      <ul class="list-inline">
        ...
        <li class="dropdown"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_account; ?></span> <span class="caret"></span></a>
          <ul class="dropdown-content dropdown-menu dropdown-menu-right" id="test">
            <?php if ($logged) { ?>
...
<?php if ($categories) { ?>
  ...
  <nav id="menu" class="navbar " style="background-color: #ffffff;background-image: none; border-radius: 0px; border-color: #3c4a55 transparent #ddd transparent;">
