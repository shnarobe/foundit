...
class ControllerModuleMultiMerchNewsellers extends ControllerSellerCatalog {
	public function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . MsLoader::getInstance()->load('\MultiMerch\Module\MultiMerch')->getViewTheme() . '/template/module/multimerch_newsellers.tpl')) {
			return $this->load->view(MsLoader::getInstance()->load('\MultiMerch\Module\MultiMerch')->getViewTheme() . '/template/module/multimerch_newsellers.tpl', $this->data);
		} else {
			return $this->load->view('default/template/module/multimerch_newsellers.tpl', $this->data);
		}
	}
}