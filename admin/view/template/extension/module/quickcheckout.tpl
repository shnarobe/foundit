            ...
            <div class="tab-pane active" id="tab-general">
			  ...
			  <div class="row">
				<div class="form-group col-sm-4">
				  ...
				  <div class="col-sm-5"><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip">
                                    <div align="center" class="onoffswitch">
                                            <input type="checkbox" name="quickcheckout_edit_cart" class="onoffswitch-checkbox" id="quickcheckout_edit_cart" value="1" <?php echo ($quickcheckout_edit_cart == '1') ? 'checked="checked"' : '' ; ?> <?php //echo $entry_readonly; ?> >
			  ...
			  <div class="row">
				<div class="form-group col-sm-4">
				  ...
				  <div class="col-sm-5"><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip">
                                    <div align="center" class="onoffswitch">
                                            <input type="checkbox" name="quickcheckout_coupon" class="onoffswitch-checkbox" id="quickcheckout_coupon" value="1" <?php echo ($quickcheckout_coupon == '1') ? 'checked="checked"' : '' ; ?> >
				...
				<div class="form-group col-sm-4">
				  ...
				  <div class="col-sm-5"><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip">
                                    <div align="center" class="onoffswitch">
                                            <input type="checkbox" name="quickcheckout_voucher" class="onoffswitch-checkbox" id="quickcheckout_voucher" value="1" <?php echo ($quickcheckout_voucher == '1') ? 'checked="checked"' : 'checked="checked"' ; ?> >
				...
				<div class="form-group col-sm-4">
				  ...
				  <div class="col-sm-5"><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip">
                                    <div align="center" class="onoffswitch">
                                            <input type="checkbox" name="quickcheckout_reward" class="onoffswitch-checkbox" id="quickcheckout_reward" value="1" <?php echo ($quickcheckout_reward == '1') ? 'checked="checked"' : '' ; ?> >
			  ...
			  <div class="row">
				<div class="form-group col-sm-4">
				  ...
				  <div class="col-sm-5"><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip">
                                    <div align="center" class="onoffswitch">
                                            <input type="checkbox" name="quickcheckout_survey" class="onoffswitch-checkbox" id="quickcheckout_survey" value="1" <?php echo ($quickcheckout_survey == '1') ? 'checked="checked"' : '' ; ?> >
				...
				<div class="form-group col-sm-4">
				  ...
				  <div class="col-sm-5"><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip">
                                    <div align="center" class="onoffswitch">
                                            <input type="checkbox" name="quickcheckout_survey_required" class="onoffswitch-checkbox" id="quickcheckout_survey_required" value="1" <?php echo ($quickcheckout_survey_required == '1') ? 'checked="checked"' : '' ; ?>   >
				  ...
				  <div class="col-sm-8">
					<?php foreach ($languages as $language) { ?>
					  <span title="<?php echo $help_readonly; ?>" data-toggle="tooltip"><div class="input-group">
						<span class="input-group-addon"><img src="<?php echo version_compare(VERSION, '2.2.0.0', '<') ? 'view/image/flags/' . $language['image'] : 'language/' . $language['code'] . '/' . $language['code'] . '.png'; ?>" title="<?php echo $language['name']; ?>" /></span>
						<input type="text" name="quickcheckout_survey_text[<?php echo $language['language_id']; ?>]" value="Do you like our Quick Checkout module?" class="form-control"  />
					  </div></span>
					<?php } ?>
				  </div>
				</div>
				...
				<?php foreach ($fields as $field) { ?>
				  ...
				  <tr>
					<td><?php echo ${'entry_field_' . $field}; ?></td>
                                        ...
                                        <td align="center"><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip">
                                            <div class="onoffswitch">
                                            <input type="checkbox" name="quickcheckout_field_<?php echo $field; ?>[required]" class="onoffswitch-checkbox" id="quickcheckout_field_<?php echo $field; ?>[required]" value="1" <?php echo !empty(${'quickcheckout_field_' . $field}['required']) ? ' checked' : ''; ?> >
						...
						<?php } ?>
                                        ...
                                        <td><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip"><input type="text" name="quickcheckout_field_<?php echo $field; ?>[sort_order]" value="<?php echo isset(${'quickcheckout_field_' . $field}['sort_order']) ? ${'quickcheckout_field_' . $field}['sort_order'] : ''; ?>" class="form-control"  /></span></td>
				  </tr>
					...
					<td><?php echo ${'entry_field_' . $field}; ?></td>
                                        ...
                                        <td>
                                         <div class="row reg-fields">
                                          ...
                                          <div class="col-sm-8"><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip"><input type="text" name="quickcheckout_field_<?php echo $field; ?>[placeholder]" value="<?php echo !empty(${'quickcheckout_field_' . $field}['placeholder']) ? ${'quickcheckout_field_' . $field}['placeholder'] : ''; ?>" class="form-control"  /></span></div>
                                         </div>
                                        </td>
				  ...
				  <tr>
					<td><?php echo ${'entry_field_' . $field}; ?></td>
                                        ...
                                        <td align="center"><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip">
                                            <div class="onoffswitch">
                                            <input type="checkbox" name="quickcheckout_field_<?php echo $field; ?>[display]" class="onoffswitch-checkbox" id="quickcheckout_field_<?php echo $field; ?>[display]" value="1" <?php echo !empty(${'quickcheckout_field_' . $field}['display']) ? ' checked' : ''; ?>  >
                                            <label class="onoffswitch-label" for="quickcheckout_field_<?php echo $field; ?>[display]">
                                                <span class="onoffswitch-inner"></span>
                                                <span class="onoffswitch-switch"></span>
                                            </label>
                                        ...
                                        <td>
                                         <div class="row reg-fields">
                                          <div class="col-sm-4 reg-field"><?php echo $text_default; ?></div>
                                          <div class="col-sm-8 text-center"><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip"><input type="checkbox" name="quickcheckout_field_<?php echo $field; ?>[default]"<?php echo !empty(${'quickcheckout_field_' . $field}['default']) ? ' checked' : ''; ?>  /></span></div>
                                         </div>
                                        </td>
			  ...
			  <table class="table table-bordered table-striped table-hover">
				...
				<tr>
				  <td><?php echo $payment_module['name']; ?></td>
                                  <td><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip"><input type="text" name="quickcheckout_payment_logo[<?php echo $payment_module['code']; ?>]" value="<?php echo isset($quickcheckout_payment_logo[$payment_module['code']]) ? $quickcheckout_payment_logo[$payment_module['code']] : ''; ?>" class="form-control" /></span></td>
				</tr>
				<?php } ?>
				<tr>
			...
			<div class="tab-pane" id="tab-shipping">
			  ...
			  <div class="row">
			    <div class="form-group col-sm-4">
				  ...
				  <div class="col-sm-5"><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip">
                                    <div align="center" class="onoffswitch">
                                            <input type="checkbox" name="quickcheckout_shipping_module" class="onoffswitch-checkbox" id="quickcheckout_shipping_module" value="1" <?php echo ($quickcheckout_shipping_module == '1') ? 'checked="checked"' : '' ; ?>>
			  ...
			  <table class="table table-bordered table-striped table-hover">
				...
				<tr>
				  <td><?php echo $shipping_module['name']; ?></td>
                                  <td><span title="<?php echo $help_readonly; ?>" data-toggle="tooltip"><input type="text" name="quickcheckout_shipping_logo[<?php echo $shipping_module['code']; ?>]" value="<?php echo isset($quickcheckout_shipping_logo[$shipping_module['code']]) ? $quickcheckout_shipping_logo[$shipping_module['code']] : ''; ?>" class="form-control"/></span></td>
				</tr>
				<?php } ?>
				<tr>
...
$('select[name=\'quickcheckout_field_country[default]\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=extension/module/quickcheckout/country&token=<?php echo $token; ?>&country_id=' + this.value,
		dataType: 'json',		
...
function store() {
	location = 'index.php?route=extension/module/quickcheckout&token=<?php echo $token; ?>&store_id=' + $('select[name=\'store_id\']').val();
}
//--></script>
<?php echo $footer; ?>