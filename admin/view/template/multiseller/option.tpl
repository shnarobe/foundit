    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a id="ms-opts-approve" data-toggle="tooltip" title="<?php echo $ms_button_approve; ?>" class="btn btn-success"><i class="fa fa-check"></i></a>
                <a id="ms-opts-delete" data-toggle="tooltip" title="<?php echo $ms_delete; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1><?php echo $ms_seller_option_breadcrumbs; ?></h1>
            </div>
            <div class="panel-body">
                <div class="table-responsive">
                    <form class="form-inline" action="" method="post" enctype="multipart/form-data" id="form-options">
                        <table class="list mmTable table table-bordered table-hover" style="text-align: center" id="list-options">
                            <thead>
                            <tr>
                                <td width="1" style="text-align: center;"><input type="checkbox" onclick="$('input[name*=\'selected\']').attr('checked', this.checked);" /></td>
                                <td><?php echo $ms_seller_option; ?></td>
