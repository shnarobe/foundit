...
class MsBalance extends Model {
	...
	const MS_BALANCE_TYPE_SHIPPING = 8;
	...
	public function getReservedSellerFunds($seller_id) {
		...
		$sql = "SELECT SUM(amount) as total
				...
				WHERE seller_id = " . (int)$seller_id . "
				AND request_type IN (" . (int)MsPgRequest::TYPE_PAYOUT . "," . (int)MsPgRequest::TYPE_PAYOUT_REQUEST . ")
				AND request_status = " . (int)MsPgRequest::STATUS_UNPAID;
